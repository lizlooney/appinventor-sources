  ...
  public void Write1Byte(int register, String number, boolean waitForCompletion) {
    ...
    if (i2cDeviceSynch != null) {
      try {
        ...
        i2cDeviceSynch.write8(register, b, waitForCompletion ? I2cWaitControl.WRITTEN : I2cWaitControl.NONE);
    ...
    if (i2cDeviceSynch != null) {
      try {
        if (byteArray instanceof byte[]) {
          ...
          i2cDeviceSynch.write(start, array, waitForCompletion ? I2cWaitControl.WRITTEN : I2cWaitControl.NONE);
        } else {
