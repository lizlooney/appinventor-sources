  ...
  private boolean writeAndroidManifest(File manifestFile, Set<String> permissionsNeeded) {
    ...
    try {
      ...
      if (isFtcRobotController) {
        ...
        out.write("    </activity>\n");
        out.write("    <activity\n");
        out.write("      android:name=\"org.firstinspires.inspection.InspectionActivity\"\n");
        out.write("      android:label=\"@string/inspection_activity\"\n");
        out.write("      android:configChanges=\"orientation|screenSize\">\n");
        out.write("      <intent-filter>\n");
        out.write("        <action android:name=\"org.firstinspires.inspection.InspectionActivity.intent.action.Launch\" />\n");
        out.write("        <category android:name=\"android.intent.category.DEFAULT\" />\n");
        out.write("      </intent-filter>\n");
        out.write("    </activity>\n");
        out.write("    <receiver\n");
